...
//load boards 
var easy = ["6------7------5-2------1---362----81--96-----71--9-4-5-2---651---78----345-------", // "68532917497148532623476185936257498154961873271829346582394651719785264345613729-",
...
function handleNumberClick(numClicked) {
  ...
  if (validateUserEntry()) {
    ...
    sleep(3000).then(function () {
      return console.log("waited 3 seconds!");
    });
